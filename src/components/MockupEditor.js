...
class MockupEditor extends Component {
    constructor(props) {
        ...
        this.apiBase = "http://dev.shubhamprajapat.com/";
    ...
    pollPreview = () => {
        ...
        fetch(
            `${this.apiBase}export/${this.targetMockup.id}/${this.state.projectid}`
        )
            .then((e) => e.json())
            .then((res) => {
                if (!res.url) {
    ...
    uploadDisplayPicture = async () => {
        ...
        fetch(
            `${this.apiBase}project/${this.targetMockup.id}/${this.state.layerCropper.layerData.id}`,
            requestOptions
        )
            ...
            .then((result) => {
                if (!result.success) {
                    alert(
                        `Something went wrong while uploading selected layer: ${result.message}`
                    );
                    return;
                }
                _finally();
            ...
            .catch((error) => {
                alert(
                    `Something went wrong while uploading selected layer: ${error}`
                );
                _finally();
                        ...
                        <div className="pr_live_mockup_preview">
                            <img
                                src={
                                    ...
                                    this.targetMockup.mockup
                                }
                                alt=""
                                draggable={false}
                            />
                            {this.state.pollPreview.stage === "FETCHING" ? (
                                <this.previewLoader />
                            ) : null}
                            {this.state.exportedPreview ? (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        a.target = "_blank";
                                        a.download =
                                            "psd-replika (shubhamprajapat.com).jpg";
                                        a.click();
                                    }}
                                >
                                    Download
